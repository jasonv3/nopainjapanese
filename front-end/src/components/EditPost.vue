<template>
  <div class="container">
    <form id="editPostForm" v-if="sharedState.is_authenticated && sharedState.user_perms.includes('write')" @submit.prevent="onSubmit" class="g-mb-40">
...
export default {
  ...
  methods: {
    ...
    async updatePost(imgossdir, oggossdir, tags) {
      ...
      const path = `/api/posts/${this.post.id}`
      const payload = {
    ...
    async onSubmit (e) {
      ...
      await this.updatePost(imgossdir, oggossdir, tags);
    },
